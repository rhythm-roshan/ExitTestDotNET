...
namespace Nagarro.CasinoPortal.Shared
{
    ...
    public sealed class OperationResult<T>
    {
        ...
        public CasinoPortalValidationResult ValidationResult { get; private set; }
        ...
        private OperationResult(T data, OperationResultType resultType, string message, string stackTrace, CasinoPortalValidationResult validationResult)
        {
            this.Data = data;
        ...
        /// <returns></returns>
        [SuppressMessage(SuppressMessageConstants.DesignCategory, SuppressMessageConstants.DoNotDeclareStaticMembersOnGenericTypes)]
        public static OperationResult<T> CreateFailureResult(CasinoPortalValidationResult validationResult)
        {
